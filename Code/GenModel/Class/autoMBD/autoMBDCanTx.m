classdef autoMBDCanTx < autoMBD
    ...
    methods
        function obj = autoMBDCanTx(ram_sht_tbl, rom_sht_tbl)
            ...
            obj.lib_normal_mdl = 'Lib/cantx_normal';
            obj.lib_error_sub = 'Lib/cantx_error';
            obj.lib_noerror_sub = 'Lib/cantx_noerror';
            obj.lib_frame_merge = 'Lib/canframe_merge';
            ...
            obj.post_sub_inport_base_pos = [560 68 590 82];
            obj.post_sub_convert_base_pos = obj.post_sub_inport_base_pos + [230 -10 275 10];
            obj.post_sub_shift_base_pos = obj.post_sub_convert_base_pos + [275 -3 285 3];
            obj.post_sub_or_base_pos = obj.post_sub_shift_base_pos + [255 1 210 -1];
            obj.post_sub_interval = 70;
        end
        function gen_normal_model(obj, save_path, model_name, model_info)
            ...
            port_num = length(get_param(normal_main_path, 'PortHandles').Inport);
