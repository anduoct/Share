...
#define S_FUNCTION_NAME  IndFunc
...
#define TIMEOUTFLAG(S) (mxGetScalar(ssGetSFcnParam(S, timeoutflag)))
#define EXTENDID(S) (mxGetScalar(ssGetSFcnParam(S, extendid)))
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    ssSetSFcnParamNotTunable(S, timeoutflag);
    ssSetSFcnParamNotTunable(S, extendid);
...
{   
    ...
    //buflen_name3 = mxGetN(TIMEOUTFLAG(S))*sizeof(mxChar)+1;
    //c_timeoutflag = mxMalloc(buflen_name3);
    //mxGetString(TIMEOUTFLAG(S),c_timeoutflag,(mwSize)buflen_name3);
    c_timeoutflag = (bool)TIMEOUTFLAG(S);

    c_extendid = (bool)EXTENDID(S);
    ...
    if (!ssWriteRTWParamSettings(S, numberOfParam,
                                ...
                                SSWRITE_VALUE_DTYPE_NUM,"r_timeoutflag",&c_timeoutflag,DTINFO(SS_BOOLEAN,COMPLEX_NO),
                                SSWRITE_VALUE_DTYPE_NUM,"r_extendid",&c_extendid,DTINFO(SS_BOOLEAN,COMPLEX_NO)
                               ))
